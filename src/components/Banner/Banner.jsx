      ...
      <div className="container py-14 grid grid-cols-1 md:grid-cols-2 space-y-6 md:space-y-0 gap-12">
        ...
        <div className="flex flex-col justify-center">
          <div className="text-center md:text-left space-y-4 lg:max-w-[450px]" >
            ...
            initial="hidden"
            whileInView="show"
              className="text 3-xl lg:text-4xl font-semibold font-poppins">The Latest Headphones With The Latest Technology</motion.h1>
            <motion.p
              variants={fadeUp(0.4)}
              initial="hidden"
              whileInView="show">
            ...
            <motion.button
              ...
              initial="hidden"
              whileInView="show"
              className="mt-6 inline-block bg-red-500 text-white text-lg font-semibold py-3 px-8 rounded-lg shadow-lg transition hover:bg-red-600">Shop Now</motion.button>
            </UpdateFollower>
